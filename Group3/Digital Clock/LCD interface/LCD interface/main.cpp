 ...
 * Author : Emancipator
 */ 
#define F_CPU 16000000  //a Clock Frequency of 16MHz
#include <avr/io.h>
...
#define usingLcd  //preprocessor directive to use LCD from the Emancipator library

#include "c://Emancipator/Emancipator.h"  //Library
